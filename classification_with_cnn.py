...
class SimpleCNN(pl.LightningModule):
    def __init__(self, num_classes=1800):
    ...
    def training_step(self, batch, batch_idx):
        ...
        result = {'val_loss': loss, 'correct': correct, 'total': len(labels)}
...
def train_model():
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor='val_loss',
        dirpath=f'models/custom_classification_cnn/{configs.custom_model_name}',
    ...
    # 接续上次训练。
    # checkpoint_path = f"models/custom_classification_cnn/{configs.custom_model_name}/best-checkpoint.ckpt"
    # model = SimpleCNN()
